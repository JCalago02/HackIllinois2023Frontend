import "../../Components/ListViewKeyCaps/ListViewKeyCaps.css"

import ItemCard from "../ItemCard/ItemCard";
import { useCallback, useState } from "react";

function ListViewKeyCap(props) {
    ...
    const vendorOptions =[
        ...
        {
            label:"The Key Company",
            value:"The Key Company"
        }, 
        {
            label:"NovelKeys",
            value:"NovelKeys"
        ...
        {
            label:"Space Holdings",
            value:"Space Holdings"
        }

    ]
    return (
        <div className="list-view">
            <div className="list-header-title-keycap">{props.title}</div>
